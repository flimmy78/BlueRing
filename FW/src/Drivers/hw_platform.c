...
#define  LOW_POWER_TH	1936		//对应的电池低电阀值为3.6V，由于没有拿到使用的电池的放电曲线，所以只能设定一个通用的锂电池低电阀值
...
/**
* @brief	LED控制接口
* @param[in]  unsigned int led	 LED_RED or  LED_GREEN  or LED_BLUE
